...
wordlists.fileids()
print
wordlists.raw('pku_training.utf8')
print
len(wordlists.words('pku_training.utf8'))
print
len(wordlists.sents('pku_training.utf8'))
